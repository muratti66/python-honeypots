...
LOG_FILE = "/opt/telnethoneypot/logs/telnethoneypot.log"
CONF_FILE = "/opt/telnethoneypot/config.cfg"
...
class HeaderWriter(object):
    ...
    def write_header(self, ip, qid):
        ...
        filename = "/opt/telnethoneypot/headers/" + time + "-" + qid
        data = "telnet;" + time + ";" + ip + ";" + qid
        try:
...
class SMTPCommandWriter(object):
    ...
    def write_commands(self, data, qid):
        ...
        :return: None
        """
        filename = "/opt/telnethoneypot/commands/" + qid
        try:
