...
LOG_FILE = "/opt/webhoneypot/logs/webhoneypot.log"
CONF_FILE = "/opt/webhoneypot/config.cfg"
...
class HeaderWriter(object):
    ...
    def write_header(self, ip, qid):
        ...
        filename = "/opt/webhoneypot/headers/" + time + "-" + qid
        data = "http;" + time + ";" + ip + ";" + qid
        try:
...
class SMTPCommandWriter(object):
    ...
    def write_commands(self, data, qid):
        ...
        :return: None
        """
        filename = "/opt/webhoneypot/commands/" + qid
        try:
...
class DATAWriter(object):
    ...
    def write_data(self, data, qid):
        filename = "/opt/webhoneypot/mails/" + qid + ".eml"
        try:
            with open(filename, 'a') as out:
